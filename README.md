...
- **`CMS_PLATFORM_PAT`** — the fallback those two reusables use until the App above is provisioned: `CMS_E2E_PAT`'s permissions **plus Workflows R/W** (the bump rewrites `.github/workflows/*` pins), minus Actions. Missing both is issue #13.
